		...
		<div class="boxin">
               ...
               <div class="content">
                 ...
                 <table width="1713" height="472" border="0">
                   <tr>
                     <td colspan="6" align="center"><h2><strong><?php echo $detail->buildingname;?> Inspection</strong></h2></td>
                   </tr>
                   <tr>
                   ...
                   <tr>
                     ...
                     <td width="341"><?php echo $detail->company;?></td>
                     <td width="494"><strong>Company/Owner Name:</strong></td>
                   ...
                   <tr>
                     <td width="157"><strong>Level</strong></td>
                     <td width="107"><strong>Area</strong></td>
                     <td width="308"><strong>Hazard Name</strong></td>
