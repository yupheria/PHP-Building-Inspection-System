	...
	<div class="box box-100 altbox">
		<div class="boxin">
			<div class="header">
				...
				<span id="toolbar">
					<?php 
						echo anchor('index.php/buildinginspection/view_hazard/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5).'/'.$this->uri->segment(6), '&laquo; Back', array('class' => 'buttonBlack', 'id' => 'backButton')); 
						if($this->session->userdata('access_level')<3) {
                                                    echo anchor('index.php/buildinginspection/delete_hazard_page/'.$this->uri->segment(3)."/".$this->uri->segment(4)."/".$this->uri->segment(5)."/".$this->uri->segment(6), 'Delete', array('class' => 'buttonBlack', 'id' => 'deleteHazard'));
