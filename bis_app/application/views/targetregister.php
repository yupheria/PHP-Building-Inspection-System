<div id="login">
	...
	*/ ?>
	...
	<div id="login_form" class="clearfix">
		<div class="header">
			<h1>Target Marketing Insure Registration</h1>
			<ul>
			...
			<p class="submit"> 
				<input 	type="button" 
                        ...
                        <div style="width: 330px; float:right;">
                           <p><strong>Target Marketing Insure</strong> <br />
                           Designed for life insurance advisors and planners to sell and service better <br />
                           <strong>Target Marketing Insure</strong> records and manages client and prospect records, and product sales record
                           </p>
                        <ul>
                        ...
                        <li>real time access to clients, prospects and policy information</li>
                       </ul></div>
		</form> 
